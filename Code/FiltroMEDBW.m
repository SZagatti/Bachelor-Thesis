...
destinationFolder = '/Users/sebastianozagatti/Desktop/DATASET3/x4/DATASET3 RESx4 bilinear MED+BW/SA';
...
% Write the png file.  This will convert whatever format you started with to the hated jpg format.
 imwrite(K, fullDestinationFileName)
...
destinationFolder = '/Users/sebastianozagatti/Desktop/DATASET3/x4/DATASET3 RESx4 bilinear MED+BW/EDGE ON';
if ~exist(destinationFolder, 'dir')
  mkdir(destinationFolder);
end
  for c = 1 : 3
...
destinationFolder = '/Users/sebastianozagatti/Desktop/DATASET3/x4/DATASET3 RESx4 bilinear MED+BW/ELLITTICHE';
if ~exist(destinationFolder, 'dir')
  mkdir(destinationFolder);
end
  for c = 1 : 3
...
destinationFolder = '/Users/sebastianozagatti/Desktop/DATASET3/x4/DATASET3 RESx4 bilinear MED+BW/SB';
if ~exist(destinationFolder, 'dir')
  mkdir(destinationFolder);
end
  for c = 1 : 3
