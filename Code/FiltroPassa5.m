...
destinationFolder = '/Users/sebastianozagatti/Desktop/DATASET3/BASE/DATASET3-ISTO-PASSA/SA';
...
destinationFolder = '/Users/sebastianozagatti/Desktop/DATASET3/BASE/DATASET3-ISTO-PASSA/EDGE ON';
if ~exist(destinationFolder, 'dir')
  mkdir(destinationFolder);
end
  LL = fft2(double(I));
...
destinationFolder = '/Users/sebastianozagatti/Desktop/DATASET3/BASE/DATASET3-ISTO-PASSA/ELLITTICHE';
if ~exist(destinationFolder, 'dir')
  mkdir(destinationFolder);
end
  LL = fft2(double(I));
...
for k = 1 : length(theFiles)
  ...
  % figure; imshow(I);
  fullSourceFileName = fullfile(myFolder, baseFileName);
destinationFolder = '/Users/sebastianozagatti/Desktop/DATASET3/BASE/DATASET3-ISTO-PASSA/SB';
if ~exist(destinationFolder, 'dir')
  mkdir(destinationFolder);
end
  LL = fft2(double(I));
