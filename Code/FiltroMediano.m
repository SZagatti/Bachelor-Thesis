...
destinationFolder = '/Users/sebastianozagatti/Desktop/DATASET3/x4/DATASET3 RESx4 bilinear FILTERED/SA';
if ~exist(destinationFolder, 'dir')
  mkdir(destinationFolder);
end
  for c = 1 : 3
    J(:, :, c) = medfilt2(I(:, :, c), [5, 5]);
  % K(:, :, c) = wiener2(I(:, :, c),[5 5]);
  end
...
destinationFolder = '/Users/sebastianozagatti/Desktop/DATASET3/x4/DATASET3 RESx4 bilinear FILTERED/EDGE ON';
if ~exist(destinationFolder, 'dir')
  mkdir(destinationFolder);
end
  for c = 1 : 3
...
destinationFolder = '/Users/sebastianozagatti/Desktop/DATASET3/x4/DATASET3 RESx4 bilinear FILTERED/ELLITTICHE';
if ~exist(destinationFolder, 'dir')
  mkdir(destinationFolder);
end
  for c = 1 : 3
...
filePattern = fullfile(myFolder, '*.png'); 
theFiles = dir(filePattern);
destinationFolder = '/Users/sebastianozagatti/Desktop/DATASET3/x4/DATASET3 RESx4 bilinear FILTERED/SB';
if ~exist(destinationFolder, 'dir')
  mkdir(destinationFolder);
end
  for c = 1 : 3
