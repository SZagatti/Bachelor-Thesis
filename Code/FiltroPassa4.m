...
destinationFolder = '/Users/sebastianozagatti/Desktop/DATASET3/BASE/DATASET3-PASSA4/SA';
if ~exist(destinationFolder, 'dir')
  mkdir(destinationFolder);
   ...
   [M N]=size(LL(:, :, c));
    ...
    % region
    Lo(1:M,1:N,c)=0;
    Lo(0.5*M-D:0.5*M+D,0.5*N-D:0.5*N+D,c)=1;
    ...
    % frequency region
    Hi(1:M,1:N,c)=1;
    Hi(0.5*M-D:0.5*M+D,0.5*N-D:0.5*N+D,c)=0;
    end
   JJ=L.*Hi;
   K = ifftshift(JJ);
...
destinationFolder = '/Users/sebastianozagatti/Desktop/DATASET3/BASE/DATASET3-PASSA4/EDGE ON';
if ~exist(destinationFolder, 'dir')
  mkdir(destinationFolder);
end
  LL = fft2(double(I));
...
destinationFolder = '/Users/sebastianozagatti/Desktop/DATASET3/BASE/DATASET3-PASSA4/ELLITTICHE';
if ~exist(destinationFolder, 'dir')
  mkdir(destinationFolder);
end
 LL = fft2(double(I));
...
for k = 1 : length(theFiles)
  ...
  % figure; imshow(I);
  fullSourceFileName = fullfile(myFolder, baseFileName);
destinationFolder = '/Users/sebastianozagatti/Desktop/DATASET3/BASE/DATASET3-PASSA4/SB';
if ~exist(destinationFolder, 'dir')
  mkdir(destinationFolder);
end
  LL = fft2(double(I));
